export const CheckboxUnchecked: React.FC<React.SVGProps<SVGSVGElement>> = ({ fill = 'currentColor', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
    <rect x="4.5" y="4.5" width="15" height="15" rx="3.5" fill="none" stroke={fill} />
  </svg>
);

export const CheckboxChecked: React.FC<React.SVGProps<SVGSVGElement>> = ({ fill = 'currentColor', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
    <rect x="4.5" y="4.5" width="15" height="15" rx="3.5" fill={fill} stroke={fill} />
    <path
