...
export const Heading = styled.div<HeadingProps>`
  ${(props) => css`
    ...
    border-right: ${props.isOpen === 'left' ? '2px solid #00E394' : '1px solid #b9b9b9'};
    > svg {
    ...
    & + ${Heading} {
      border-radius: ${props.isOpen
        ...
        : '0 0.75rem 0.75rem 0'};
      border-right: none;
      box-shadow: ${props.isOpen === 'right' ? '0.125rem 0.125rem 0 0 #00E394' : 'none'};
    }
  `}
`;
...
export const Content = styled.div<ContentProps>`
  ...
  border-radius: ${(props) => (props.isOpen === 'right' ? '0.75rem 0' : '0 0.75rem')} 0.75rem 0.75rem;
  z-index: 5;
  left: 0;
  right: 0;
  top: 100%;
